	...
	<div class="swiper">
		<div class="swiper-top">
			<div style="color: gray;font-size: 16px;">
				注意：请勿轻易删除NARUI板块，否则可能会出现意想不到的错误。
			</div>
		...
		<div class="swiper-content">
			...
			<div class="swiper-content-top">
				<el-table :data="data_list" stripe style="width: 100%">
					...
					<el-table-column prop="plate_name" label="所属板块">
					</el-table-column>
					...
					<el-table-column fixed="right" label="操作">
						<template slot-scope="scope">
							<el-button type="text"  @click="todelete(scope.row)" v-if="scope.row.type!=2">删除</el-button>
		...
		<el-dialog :title="aimitem?'编辑'+'分类':'新增'+'分类'" :visible.sync="edit" :close-on-click-modal="false">
...
<script>
	export default {
		...
		methods: {
			...
			toshow(e,es){
				var that = this
				that.$api.post('/OpClassification', {
					optype: 2,
					delete: 0,
					id: e.id,
					status:es
